...
const About = () => {
  return (
    <div>
      ...
      <div className="w-full border border-red-600 flex flex-col ">
        <div className="flex flex-col gap-5 mt-14 m-6">
          <div className="img1 h-52 object-cover ">
            <img
              className="h-full w-full"
              src="https://plus.unsplash.com/premium_photo-1661381087101-5ac6567bdf53?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGJlYWNoJTIwcGFydHl8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
